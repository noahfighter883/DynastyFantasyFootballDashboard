...
import type { Acquisition, AcquisitionMap } from '../data/acquisitionsData'
import { acquisitionDetail, acquisitionStyle } from '../data/acquisitionsData'
  ...
  return (
    ...
    >
      ...
      <div key={acquisition === undefined ? 'loading' : 'loaded'} className={acquisition !== undefined ? 'row-enter' : undefined}>
        ...
        {acquisition && acquisitionDetail(acquisition) && (
          <div style={{ fontSize: 10, color: '#4b5563', fontWeight: 400, marginTop: 2 }}>
            {acquisitionDetail(acquisition)}
          </div>
        )}
        {acquisition === null && (
